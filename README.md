...
A fast, explicit segregated free-list allocator implemented in C11. It uses a "Best-Fit" search strategy within power-of-two size classes and supports immediate coalescing via boundary tags.
